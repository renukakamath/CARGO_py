...
public class Deliveryviewassignedcargos extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliveryviewassignedcargos);
        ...
        JR.json_response = (JsonResponse) Deliveryviewassignedcargos.this;
        String q = "/deliveryboyvieworderdispatched?lid="+sh.getString("log_id","");
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if (method.equalsIgnoreCase("deliveryboyupdatestatustopickup")) {
            ...
            } else if (method.equalsIgnoreCase("deliveryboyvieworderdispatched")) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Deliveryviewassignedcargos.this);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("PickUp")) {
                    ...
                    JsonReq JR = new JsonReq();
                    JR.json_response = (JsonResponse) Deliveryviewassignedcargos.this;
                    String q = "/deliveryboyupdatestatustopickup?oid="+Deliveryviewassignedcargos.oids+"&lid="+sh.getString("log_id","");
                    q = q.replace(" ", "%20");
                    JR.execute(q);
