...
//                place=e5.getText().toString();
                ...
                else if(lname.equalsIgnoreCase("") || !fname.matches("[a-zA-Z ]+"))
                {
...
//                }
                ...
                else if(password.equalsIgnoreCase("") || password.length()<=5)
                {
                    ...
                    String q ="/userregister?fname="+fname+"&lname="+lname+"&phone="+phone+"&email="+email+"&username="+user+"&password="+password+"&latitude="+LocationService.lati+"&longitude="+LocationService.logi;
                    q = q.replace(" ","%20");
                    JR.execute(q);
                }
            }
